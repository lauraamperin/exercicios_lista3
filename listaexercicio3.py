...
ax.plot(df_projetos["Data"], df_projetos["Projeto4"], label= "Projeto4")
ax.plot(df_projetos["Data"], df_projetos["Projeto5"], label= "Projeto5")
ax.set_title("Evolução dos Valores dos Projetos ao Longo do Tempo")
ax.set_xlabel("Data")
ax.set_ylabel("Valor do Projeto")
ax.legend()
ax.grid(True)
fig.tight_layout()
